<?php include('partials/header.php'); ?>
    ...
    <section class="property-details overflow-hidden">
        <div class="container">
                            ...
                            <div class="swiper th-slider panoramaSlide2 mb-4" id="panoramaSlide2" data-slider-options='{"autoplay":false,"effect":"fade","loop":true, "simulateTouch": false,"thumbs":{"swiper":".property-thumb-slider"},"autoplayDisableOnInteraction":"true"}'>
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="property-slider-img propery-single-slide" id="panorama1"><img src="assets/img/explore-cites/explore-cites-bg-1.jpg" alt="img"></div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="property-slider-img propery-single-slide" id="panorama2"><img src="assets/img/explore-cites/explore-cites-bg-2.jpg" alt="img"></div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="property-slider-img propery-single-slide" id="panorama3"><img src="assets/img/explore-cites/explore-cites-bg-3.jpg" alt="img"></div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="property-slider-img propery-single-slide" id="panorama4"><img src="assets/img/explore-cites/explore-cites-bg-4.jpg" alt="img"></div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="property-slider-img propery-single-slide" id="panorama5"><img src="assets/img/explore-cites/explore-cites-bg-5.jpg" alt="img"></div>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper th-slider property-thumb-slider slider-tab" data-slider-options='{"effect":"slide","loop":true, "simulateTouch": true,"breakpoints":{"0":{"slidesPerView":2},"576":{"slidesPerView":"2"},"768":{"slidesPerView":"3"},"992":{"slidesPerView":"3"},"1200":{"slidesPerView":"4"}},"autoplayDisableOnInteraction":"true"}'>
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide" data-bg-src="">
                                        <div class="tab-btn property-slider-img"><img src="assets/img/explore-cites/explore-cites-bg-1.jpg" alt="img"></div>
                                    </div>
                                    <div class="swiper-slide" data-bg-src="">
                                        <div class="tab-btn property-slider-img"><img src="assets/img/explore-cites/explore-cites-bg-2.jpg" alt="img"></div>
                                    </div>
                                    <div class="swiper-slide" data-bg-src="">
                                        <div class="tab-btn property-slider-img"><img src="assets/img/explore-cites/explore-cites-bg-3.jpg" alt="img"></div>
                                    </div>
                                    <div class="swiper-slide" data-bg-src="">
                                        <div class="tab-btn property-slider-img"><img src="assets/img/explore-cites/explore-cites-bg-4.jpg" alt="img"></div>
                                    </div>
                                    <div class="swiper-slide" data-bg-src="">
                                        <div class="tab-btn property-slider-img"><img src="assets/img/explore-cites/explore-cites-bg-5.jpg" alt="img"></div>
                                    </div>
                                </div>
                            </div><button data-slider-prev="#panoramaSlide2" class="slider-arrow slider-prev"><i class="far fa-arrow-left"></i></button> <button data-slider-next="#panoramaSlide2" class="slider-arrow slider-next"><i class="far fa-arrow-right"></i></button>
                        </div>
                        <div class="property-page-single">
                            <div class="page-content">
                                ...
                                <ul class="property-grid-list fadeinup wow">
                                    <li>
                                        <div class="property-grid-list-icon"><img src="assets/img/icon/property-single-icon1-1.svg" alt="img"></div>
                                    ...
                                    <li>
                                        <div class="property-grid-list-icon"><img src="assets/img/icon/property-single-icon1-2.svg" alt="img"></div>
                                        <div class="property-grid-list-details">
                                    ...
                                    <li>
                                        <div class="property-grid-list-icon"><img src="assets/img/icon/property-single-icon1-3.svg" alt="img"></div>
                                        <div class="property-grid-list-details">
                                    ...
                                    <li>
                                        <div class="property-grid-list-icon"><img src="assets/img/icon/property-single-icon1-4.svg" alt="img"></div>
                                        <div class="property-grid-list-details">
                                    ...
                                    <li>
                                        <div class="property-grid-list-icon"><img src="assets/img/icon/property-single-icon1-5.svg" alt="img"></div>
                                        <div class="property-grid-list-details">
                                    ...
                                    <li>
                                        <div class="property-grid-list-icon"><img src="assets/img/icon/property-single-icon1-6.svg" alt="img"></div>
                                        <div class="property-grid-list-details">
                                    ...
                                    <li>
                                        <div class="property-grid-list-icon"><img src="assets/img/icon/property-single-icon1-7.svg" alt="img"></div>
                                        <div class="property-grid-list-details">
                                    ...
                                    <li>
                                        <div class="property-grid-list-icon"><img src="assets/img/icon/property-single-icon1-8.svg" alt="img"></div>
                                        <div class="property-grid-list-details">
                                    ...
                                    <li>
                                        <div class="property-grid-list-icon"><img src="assets/img/icon/property-single-icon1-9.svg" alt="img"></div>
                                        <div class="property-grid-list-details">
                                    ...
                                    <li>
                                        <div class="property-grid-list-icon"><img src="assets/img/icon/property-single-icon1-10.svg" alt="img"></div>
                                        <div class="property-grid-list-details">
                                    ...
                                    <li>
                                        <div class="property-grid-list-icon"><img src="assets/img/icon/property-single-icon1-11.svg" alt="img"></div>
                                        <div class="property-grid-list-details">
                                    ...
                                    <li>
                                        <div class="property-grid-list-icon"><img src="assets/img/icon/property-single-icon1-12.svg" alt="img"></div>
                                        <div class="property-grid-list-details">
                                ...
                                <div class="row gy-4 fadeinup wow">
                                    <div class="col-xl-7">
                                        <div class="property-gallery-card">
                                            <div class="property-gallery-card-img"><img class="w-100" src="assets/img/property-details/property-details_gal_1.jpg" alt="img"></div><a class="icon-btn popup-image" href="assets/img/property-details/property-details_gal_1.jpg"><i class="fa-solid fa-eye"></i></a>
                                        </div>
                                    </div>
                                    <div class="col-xl-5">
                                        <div class="property-gallery-card">
                                            <div class="property-gallery-card-img"><img class="w-100" src="assets/img/property-details/property-details_gal_2.jpg" alt="img"></div><a class="icon-btn popup-image" href="assets/img/property-details/property-details_gal_2.jpg"><i class="fa-solid fa-eye"></i></a>
                                        </div>
                                    </div>
                                    <div class="col-xl-5">
                                        <div class="property-gallery-card">
                                            <div class="property-gallery-card-img"><img class="w-100" src="assets/img/property-details/property-details_gal_3.jpg" alt="img"></div><a class="icon-btn popup-image" href="assets/img/property-details/property-details_gal_3.jpg"><i class="fa-solid fa-eye"></i></a>
                                        </div>
                                    </div>
                                    <div class="col-xl-7">
                                        <div class="property-gallery-card">
                                            <div class="property-gallery-card-img"><img class="w-100" src="assets/img/property-details/property-details_gal_4.jpg" alt="img"></div><a class="icon-btn popup-image" href="assets/img/property-details/property-details_gal_4.jpg"><i class="fa-solid fa-eye"></i></a>
                                        </div>
                                    </div>
                                    <div class="col-xl-7">
                                        <div class="property-gallery-card">
                                            <div class="property-gallery-card-img"><img class="w-100" src="assets/img/property-details/property-details_gal_5.jpg" alt="img"></div><a class="icon-btn popup-image" href="assets/img/property-details/property-details_gal_5.jpg"><i class="fa-solid fa-eye"></i></a>
                                        </div>
                                    </div>
                                    <div class="col-xl-5">
                                        <div class="property-gallery-card">
                                            <div class="property-gallery-card-img"><img class="w-100" src="assets/img/property-details/property-details_gal_6.jpg" alt="img"></div><a class="icon-btn popup-image" href="assets/img/property-details/property-details_gal_6.jpg"><i class="fa-solid fa-eye"></i></a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row gy-30 align-items-center justify-content-center justify-content-between fadeinup wow mb-40 mt-40">
                                    <div class="col-lg-auto">
                                        <h3 class="page-title mb-0">Floor Plan</h3>
                                    </div>
                                    <div class="col-lg-auto">
                                        <ul class="nav nav-tabs property-tab mb-0" role="tablist">
                                            <li class="nav-item" role="presentation"><button class="nav-link active" id="floor-tab1" data-bs-toggle="tab" data-bs-target="#floor-tab1-pane" type="button" role="tab" aria-controls="floor-tab1-pane" aria-selected="true">First Floor</button></li>
                                            <li class="nav-item" role="presentation"><button class="nav-link" id="floor-tab2" data-bs-toggle="tab" data-bs-target="#floor-tab2-pane" type="button" role="tab" aria-controls="floor-tab2-pane" aria-selected="false">Second Floor</button></li>
                                            <li class="nav-item" role="presentation"><button class="nav-link" id="floor-tab3" data-bs-toggle="tab" data-bs-target="#floor-tab3-pane" type="button" role="tab" aria-controls="floor-tab3-pane" aria-selected="false">Third Floor</button></li>
                                            <li class="nav-item" role="presentation"><button class="nav-link" id="floor-tab4" data-bs-toggle="tab" data-bs-target="#floor-tab4-pane" type="button" role="tab" aria-controls="floor-tab4-pane" aria-selected="false">Top Garden</button></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="tab-content">
                                    <div class="tab-pane fade show active" id="floor-tab1-pane" role="tabpanel" aria-labelledby="floor-tab1" tabindex="0">
                                        <div class="property-grid-plan fadeinup wow">
                                            <div class="property-grid-thumb"><img src="assets/img/property-details/property__plan_1.jpg" alt="img"></div>
                                            <div class="property-grid-details">
                                                <h4 class="property-grid-title">First Floor</h4>
                                                <p class="property-grid-text mb-25">Doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Dolorem ipsum quia dolor sit amet,</p>
                                                <p class="text-desc">consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade fadeinup wow" id="floor-tab2-pane" role="tabpanel" aria-labelledby="floor-tab2" tabindex="0">
                                ...
                                <div class="location-map fadeinup wow">
                                    ...
                                    <div class="location-map-address">
                                        <div class="thumb"><img src="assets/img/property-details/property-details_1.jpg" alt="img"></div>
