                     ...
                     <div class="footer-item-wrap">
                        <div class="footer-item">
                           <div class="widget widget_nav_menu footer-widget">
                              ...
                              <div class="menu-all-pages-container">
                                 <ul class="menu">
                                    <li><a href="service.php">#Villa</a></li>
                                    <li><a href="service.php">#Commercial</a></li>
                                    <li><a href="service.php">#Farm Houses</a></li>
                                    <li><a href="service.php">#Apartments</a></li>
                                    <li><a href="service.php">#Apartments</a></li>
                                 </ul>
                              </div>
                           </div>
                        ...
                        <div class="footer-item">
                           <div class="widget widget_nav_menu footer-widget">
                              ...
                              <div class="menu-all-pages-container">
                                 <ul class="menu">
                                    <li><a href="service.php">Strategy Services</a></li>
                                    <li><a href="service.php">Management</a></li>
                                    <li><a href="service.php">Privacy & Policy</a></li>
                                    <li><a href="service.php">Sitemap</a></li>
                                    <li><a href="service.php">Term & Conditions</a></li>
                                 </ul>
                              </div>
                           </div>
                        </div>
                     ...
                     <div class="footer-right-bottom-wrap">
                        <div class="footer-right-bottom-item">
                           ...
                           <div class="footer-right-bottom-item__content">
                              <h4 class="box-title"><a href="contact.php">Need to Home buy or sell?</a></h4>
                           </div>
                        </div>
